    ...
    ScrollView {
      VStack(alignment: .leading, spacing: 24) {
        ...
        LazyVGrid(columns: columns, spacing: 14) {
          ...
          tool("Reality Check", "What your history actually shows", "chart.line.downtrend.xyaxis", .calibration, .orange)
          tool("Where to Apply", "Rank your shortlist before you write", "list.number", .opportunityRanking, .yellow)
          tool("Benchmarks", "How you compare to people searching like you", "chart.bar.xaxis", .benchmarks, .purple)
