# Resume Studio App Store Metadata — English (U.S.)
...
Create a professional résumé, tailor it to each opportunity and manage your job search from one private career workspace.

Resume Studio combines flexible résumé design with practical career tools. Build from a fictional example or a blank document, choose a style, check your content and export a polished application without a watermark.

BUILD AND DESIGN

- Create multiple résumé versions for different roles.
- Choose from professional résumé and cover-letter templates.
...
resume,curriculum vitae,cover letter,job search,ATS,career,interview,applications,PDF,DOCX
...
Resume Studio does not require an account or sign-in. On first launch, reviewers can choose the fictional example résumé to access the complete workspace immediately.
